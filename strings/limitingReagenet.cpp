...
//************************************************************************************************************************************************************************************************
//************************************************************************************************************************************************************************************************
int solve(string pantry,string compound){
    unordered_map<char,int> c;
    int lp=pantry.length();
    int cp=compound.length();
...
{
    string compound="balloon";
    return solve(text,compound);
}
