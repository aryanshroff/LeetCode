...
//************************************************************************************************************************************************************************************************
//************************************************************************************************************************************************************************************************
void dfs(TreeNode *root, int &res, TreeNode *parent)
{
    if (root == NULL)
    {
        return;
    ...
    {
        // reached here means root is greater than parent
        // no modification on root needed
        // simply call dfs 
        res++;

        dfs(root->left, res, parent);
        dfs(root->right, res, parent);
        return;
    }
//reached here means child is smaller than parent , res as it is
    // modfiy the root to store the greatest value in path i.e parent value
    root->val = parent->val;
    dfs(root->left, res, parent);
    dfs(root->right, res, parent);
}
